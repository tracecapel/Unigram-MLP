...
public class Parse {
    public static HashMap<Integer, String> initializeConversationMap(File file) throws FileNotFoundException{
    ...
    public static HashMap<String, Integer> initializeWordMap(HashMap<Integer, String> convoMap){
        int index = 0;
